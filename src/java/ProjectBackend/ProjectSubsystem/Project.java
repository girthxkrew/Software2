...
public abstract class Project {
	...
	public Project()
	{
		...
		this.state_system = -1;
		this.type = -1;
		this.federal_fiscal_year = new java.sql.Date(Calendar.getInstance().getTime().getTime());
                this.network_Year = new java.sql.Date(Calendar.getInstance().getTime().getTime());
