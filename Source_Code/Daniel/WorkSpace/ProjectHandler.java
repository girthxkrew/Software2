...
public class ProjectHandler extends Handler{
	...
	public boolean edit(FundedProject projectObject){
		...
		String psqlVerify = "SELECT * FROM cs4311team9sp16.FUNDEDPROJECT WHERE approved_project_id='"+ projectObject.getProject_id()+"';";
		try{
			editStmt = conn.createStatement();
			editStmt.execute(sql[0]);
			resultVerify = editStmt.executeQuery(sqlVerify);
			resultVerify.next();
			secondeditStmt = conn.createStatement();
			secondeditStmt.executeQuery(sql[1]);
			secondVerify = secondeditStmt.executeQuery(psqlVerify);
			secondVerify.next();
			if(editVerification(projectObject,resultVerify,secondVerify))
				result = true;
	...
	public boolean edit(SubmittedProject projectObject){
		...
		String [] sql = editQueryBuilder(projectObject);
		String sqlVerify = "SELECT * FROM cs4311team9sp16.Project WHERE project_id='"+ projectObject.getProject_id()+"';"; 
		String psqlVerify = "SELECT * FROM cs4311team9sp16.SUBMITTEDPROJECT WHERE approved_project_id='"+ projectObject.getProject_id()+"';";
		try{
			editStmt = conn.createStatement();
			editStmt.execute(sql[0]);
			resultVerify = editStmt.executeQuery(sqlVerify);
	...
	public boolean edit(TransitFundedProject projectObject){
		...
		String [] sql = editQueryBuilder(projectObject);
		String sqlVerify = "SELECT * FROM cs4311team9sp16.Project WHERE project_id='"+ projectObject.getProject_id()+"';"; 
		String psqlVerify = "SELECT * FROM cs4311team9sp16.TRANSITFUNDEDPROJECT WHERE approved_project_id='"+ projectObject.getProject_id()+"';";
		try{
			editStmt = conn.createStatement();
			editStmt.execute(sql[0]);
			resultVerify = editStmt.executeQuery(sqlVerify);
	...
	public String [] editQueryBuilder(ProposedProject projectObject){
		...
		if(projectObject.getAir_quality_analysis_co()!= null && !projectObject.getAir_quality_analysis_co().isEmpty())
			query = query.concat("air_quality_analysis_co = '"+ projectObject.getAir_quality_analysis_co()+"',");
		if(projectObject.getAir_quality_analysis_nox() != null && !projectObject.getAir_quality_analysis_nox().isEmpty())
			query = query.concat("air_quality_analysis_nox = '"+ projectObject.getAir_quality_analysis_nox()+"',");
		if(projectObject.getAir_quality_analysis_voc() != null && !projectObject.getAir_quality_analysis_voc().isEmpty())
		...
		if(projectObject.getNameOfHighwayorRoadway() != null && !projectObject.getNameOfHighwayorRoadway().isEmpty())
		...
		if(projectObject.getProject_description() != null && !projectObject.getProject_description().isEmpty())
			query = query.concat("project_description = '" + projectObject.getProject_description() + "',");
		if(projectObject.getProject_id() != null && !projectObject.getProject_id().isEmpty())
		...
		if(projectObject.getRemarks() != null && !projectObject.getRemarks().isEmpty())
			query = query.concat("remarks = '" + projectObject.getRemarks() + "',");
		if(projectObject.getScope_of_work() != null && !projectObject.getScope_of_work().isEmpty())
			query = query.concat("scope_of_work = '" + projectObject.getScope_of_work()+"',");
		if(projectObject.getSponsoring_agency() != null && !projectObject.getSponsoring_agency().isEmpty())
		...
		if(projectObject.getProject_name() != null && !projectObject.getProject_name().isEmpty())
		...
		if(!!projectObject.getApproved_project_id().isEmpty())
		...
		if(!projectObject.getCn().isEmpty())
			secondQuery = secondQuery.concat("cs = '" + projectObject.getCn() + "',");
		if(!projectObject.getCsj().isEmpty())
		...
		if(!projectObject.getMpo_id().isEmpty())
			secondQuery = secondQuery.concat("mpo_id = '" + projectObject.getMpo_id() + "',");
		if(!projectObject.getProject_id().isEmpty())
	...
	public String [] editQueryBuilder(FundedProject projectObject){
		...
		if(projectObject.getArea() != -1)
			query = query.concat("area = " + projectObject.getArea()+",");
		if(projectObject.isCapacity_project() == true || projectObject.isCapacity_project() == false)
			query = query.concat("isCapacity_project() = " + projectObject.isCapacity_project()+",");
		if(projectObject.getCity() != -1)
			query = query.concat("city =" + projectObject.getCity() + ",");
		if(projectObject.getCounty() != -1)
			query = query.concat("county = " + projectObject.getCounty() + ",");
		...
		if(!projectObject.getTip_name().isEmpty())
			secondQuery = secondQuery.concat("tip_name =" + projectObject.getTip_name()+ ",");
		if(!projectObject.getTip_year().toString().isEmpty())
	...
	public String [] editQueryBuilder(TransitFundedProject projectObject){
		...
		if(!projectObject.getTdc_award_amount().isEmpty())
	...
	public String [] editQueryBuilder(TransitProposedProject projectObject){
		...
		if(!projectObject.getSection_5309ID().isEmpty())
			secondQuery = secondQuery.concat("section_5309ID = '" + projectObject.getSection_5309ID() + "',");
		if(!projectObject.getTcd_amount_requested().isEmpty())
	...
	public boolean editVerification(ProposedProject projectObject,ResultSet resultVerify, ResultSet secondVerify) throws SQLException{
		if(projectObject.getAir_quality_analysis_co() != null && !projectObject.getAir_quality_analysis_co().isEmpty() && !projectObject.getAir_quality_analysis_co().equals(resultVerify.getString(1)))
			return false;
		if(projectObject.getAir_quality_analysis_nox() != null && !projectObject.getAir_quality_analysis_nox().isEmpty() && !projectObject.getAir_quality_analysis_nox().equals(resultVerify.getString(2)))
			return false;
		if(projectObject.getAir_quality_analysis_voc() != null && !projectObject.getAir_quality_analysis_voc().isEmpty() && !projectObject.getAir_quality_analysis_voc().equals(resultVerify.getString(3)))
			return false;
		...
		if(projectObject.getFund_type() != -1 && projectObject.getFund_type() != resultVerify.getInt(11))
			return false;
		if(projectObject.getNameOfHighwayorRoadway() != null && !projectObject.getNameOfHighwayorRoadway().isEmpty() && !projectObject.getNameOfHighwayorRoadway().equals(resultVerify.getString(12)))
			return false;
		...
		if(projectObject.getNumber_of_project_lanes() != -1 && projectObject.getNumber_of_project_lanes() != resultVerify.getInt(16))
			return false;
		if(projectObject.getProject_description() != null && !projectObject.getProject_description().isEmpty() && !projectObject.getProject_description().equals(resultVerify.getString(17)))
			return false;
		if(projectObject.getProject_id() != null && !projectObject.getProject_id().isEmpty() && !projectObject.getProject_id().equals(resultVerify.getString(17)))
			return false;
		...
		if(projectObject.getType() != -1 && projectObject.getType() !=  resultVerify.getInt(20))
			return false;
		if(projectObject.getRemarks() != null && !projectObject.getRemarks().isEmpty() && !projectObject.getRemarks().equals(resultVerify.getString(20)))
			return false;
		if(projectObject.getScope_of_work() != null && !projectObject.getScope_of_work().isEmpty() && !projectObject.getScope_of_work().equals(resultVerify.getString(21)))
			return false;
		if(projectObject.getSponsoring_agency() != null && !projectObject.getSponsoring_agency().isEmpty() && !projectObject.getSponsoring_agency().equals(resultVerify.getString(22)))
			return false;
		if(projectObject.getState_system() != -1 && projectObject.getState_system() != resultVerify.getInt(23))
			return false;
		if(projectObject.getProject_name() != null && !projectObject.getProject_name().isEmpty() &&!projectObject.getProject_name().equals(resultVerify.getString(23)))
			return false;
		...
		if(projectObject.getLimitFrom().getLongitude() != -1.0 && projectObject.getLimitFrom().getLongitude() != resultVerify.getDouble(27))
			return false;
		//Begin proposed project exclusive fields
		if(!projectObject.getApproved_project_id().isEmpty() && !projectObject.getApproved_project_id().equals(resultVerify.getString(27)))
			return false;
		...
		if(projectObject.getSubmission_deadline() != null && !projectObject.getSubmission_deadline().equals(resultVerify.getInt(30)))
			return false;
		if(!projectObject.getCn().isEmpty() && !projectObject.getCn().equals(secondVerify.getInt(1)))
			return false;
		if(!projectObject.getCsj().isEmpty() && !projectObject.getCsj().equals(secondVerify.getInt(2)))
			return false;
		if(projectObject.getFund_type() != -1 && projectObject.getFund_type() != secondVerify.getInt(3))
			return false;
		if(!projectObject.getMpo_id().isEmpty() && !projectObject.getMpo_id().equals(secondVerify.getString(4)))
			return false;
		if(!projectObject.getProject_id().isEmpty() && !projectObject.getProject_id().equals(secondVerify.getString(5)))
			return false;
		return true;
	}
	public boolean editVerification(FundedProject projectObject,ResultSet resultVerify, ResultSet secondVerify) throws SQLException{
		...
		if(projectObject.getDate() != null && !projectObject.getDate().toString().equals(secondVerify.getString(1)))
			return false;
		if(!projectObject.getTip_name().isEmpty() && projectObject.getTip_name().equals(secondVerify.getString(2)))
			return false;
		if(!projectObject.getTip_year().toString().isEmpty() && !projectObject.getTip_year().toString().equals(secondVerify.getString(3)))
			return false;
		if(!projectObject.getProject_id().isEmpty() && !projectObject.getProject_id().equals(secondVerify.getString(4)))
			return false;
		return true;
	}
	...
	public boolean editVerification(SubmittedProject projectObject,ResultSet resultVerify, ResultSet secondVerify) throws SQLException{
		...
		if(!projectObject.getTpb_approval().isEmpty() && projectObject.getTpb_approval().equals(secondVerify.getDouble(1)))
			return false;
		if(!projectObject.getFederal_approval().isEmpty() && projectObject.getFederal_approval().equals(secondVerify.getDouble(2)))
			return false;
		if(!projectObject.getState_approval().isEmpty() && projectObject.getState_approval().equals(secondVerify.getDouble(3)))
			return false;
		if(!projectObject.getSubmission_status().isEmpty() && projectObject.getSubmission_status().equals(secondVerify.getDouble(4)))
			return false;
		return true;
	}
	public boolean editVerification(TransitFundedProject projectObject,ResultSet resultVerify, ResultSet secondVerify) throws SQLException{
		...
		if(!projectObject.getTdc_award_amount().isEmpty() && !projectObject.getTdc_award_amount().equals(secondVerify.getString(1)))
			return false;
		if(projectObject.getTdc_award_date() != null && !projectObject.getTdc_award_date().toString().equals(secondVerify.getDate(2).toString()))
			return false;
		if(!projectObject.getProject_id().isEmpty() && !projectObject.getProject_id().equals((secondVerify.getString(3))))
			return false;
		return true;
	}
	public boolean editVerification(TransitProposedProject projectObject,ResultSet resultVerify, ResultSet secondVerify) throws SQLException{
		...
		if(projectObject.getApportionment_year() != null && !projectObject.getApportionment_year().toString().equals(secondVerify.getDate(1).toString()))
			return false;
		if(!projectObject.getSection_5309ID().isEmpty() && !projectObject.getSection_5309ID().equals(secondVerify.getString(2)))
			return false;
		if(!projectObject.getTcd_amount_requested().isEmpty() && !projectObject.getTcd_amount_requested().equals(secondVerify.getString(3)))
			return false;
		//if(projectObject.getTptype() >= 0 && projectObject.getTptype() == resultVerify.getBoolean(31))
			//return false;
		if(!projectObject.getProject_id().isEmpty())
			return false;
		return true;
